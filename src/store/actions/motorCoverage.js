...
//       return dispatch(fetchGenerateCoveragesSuccess(result.errMsg));
//     }
//   };
// };
...
export const fetchAllMortgage = () => {
  return (dispatch) => {
    ...
    return axiosRequest
      ...
      .then((res) => {
        return dispatch(fetchMortgageSuccess(res?.errMsg));
      })
      .catch((error) => {
...
export const fetchAllMortgageClause = () => {
  return (dispatch) => {
    ...
    return axiosRequest
      ...
      .then((res) => {
        return dispatch(fetchMortgageClauseSuccess(res?.errMsg));
      })
      .catch((error) => {

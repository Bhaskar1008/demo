  ...
  const searchAdvisorFunc = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (searchAdvisorText !== "") {
          setAdvisorArr(res.data.errMsg.filter((i) => Object.values(i).join(" ").toLowerCase().includes(searchAdvisorText.toLowerCase())));
        } else {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (searchCustomerText !== "") {
          setCustomerArr(res.data.errMsg.filter((i) => Object.values(i).join(" ").toLowerCase().includes(searchCustomerText.toLowerCase())));
        } else {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (searchProspectText !== "") {
          setProspectArr(res.data.errMsg.filter((i) => Object.values(i).join(" ").toLowerCase().includes(searchProspectText.toLowerCase())));
        } else {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (searchTeamText !== "" && searchTeamText.length >= 3) {
          setTeamArr(res.data.errMsg.filter((i) => Object.values(i).join(" ").toLowerCase().includes(searchTeamText.toLowerCase())));
        } else {
  ...
  const uploadHostPostFunc = async (id) => {
    ...
    const uploadResult = await axios({
      ...
      .then(async (res) => {
        ...
        message.success(res?.data?.errMsg.message);
        setTimeout(() => {
  ...
  const putOrUpdateAppointmentFunc = async (res) => {
    ...
    let updateResult = await axiosRequest.put(
      `user/updateAppointment`,
      {
        ...
        eventAttendeeCount: res?.data?.errMsg.eventAttendeeCount ? res?.data?.errMsg.eventAttendeeCount : countOfParticipants,

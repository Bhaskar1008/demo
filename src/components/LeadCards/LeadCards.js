              ...
              <>
                <Col xs={12} sm={12} md={10} lg={8} xl={4} style={{ marginTop: "1.5rem" }}>
                  {(currentActiveTab === "team" && allocateBtnStatus) || roleName === "Agent" ? (
                    ...
                    <button onClick={() => handleChangeTab("self")} key={"self"} className={currentActiveTab === "self" ? "active_tabs_button" : "tabs_button"}>
                      <img src={currentActiveTab === "self" ? person_white : person_black} className="person" alt="person_png" /> Self
                    </button>
                  )}
                </Col>

                <Col xs={12} sm={12} md={10} lg={4} xl={4} style={{ marginTop: "1.5rem" }}>
                  {(currentActiveTab === "self" && allocateBtnStatus) || roleName === "Agent" ? (
                    ""
                  ) : (
                    <button onClick={() => handleChangeTab("team")} key={"team"} className={currentActiveTab === "team" ? "active_tabs_button" : "tabs_button"}>
    ...
    <>
      ...
      <div className={props.leads.length > 0 ? "for-tab-button-filter" : "for-tab-button-filter-display"}>
        <Row gutter={[16, 16]}>
          {checkAgent() === false && (
            <>
              <Col xs={8} sm={12} md={10} lg={8} xl={4} style={{ marginTop: "1.5rem" }}>
                {(currentActiveTab === "team" && allocateBtnStatus) || roleName === "Agent" ? (
                  ""
                ) : (
                  <>
              ...
              <Col xs={8} sm={12} md={10} lg={4} xl={4} style={{ marginTop: "1.5rem" }}>
                {(currentActiveTab === "self" && allocateBtnStatus) || roleName === "Agent" ? (
                  ""
                ) : (
                  <>
          ...
          <Col xs={8} sm={12} md={4} lg={4} xl={4} style={{ marginTop: "1.5rem" }}>
            <GlobalFilters show={show} onHide={handleClose} handleShow={handleShow} setShow={setShow} />
          </Col>
        </Row>
        <Row gutter={16} style={{ marginTop: "20px" }}>
      ...
      <div className="cardalign">
        <Row justify="space-between" style={{ backgroundColor: "rgb(241 238 238)" }} gutter={2}>
          ...
          <Col sm={18} md={18} lg={12} xl={12} span={10} className={width < breakpoint ? "dummy-card-mobile" : "dummy-card-desktop"}>
            <>
              <Card
                // key={id}

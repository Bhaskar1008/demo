...
import SimpleHeader from '../../OONA/OonaHeader/SimpleHeader'
...
export default function SuccessMotor() {
  ...
  let refranceNumber = SuccessMotorCustomer?.motorPolicyResponse?.errMsg?.oonaPolicyResponse?.referenceNumber

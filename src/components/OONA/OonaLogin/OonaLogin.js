  ...
  const submitHandler = (formData) => {
    ...
    axiosRequest
      ...
      .then((res) => {
        console.log(res, "res");
        //  if (res.errCode == -1) {
        // login_user_data.primaryEmail = res.errMsg.primaryEmail;
        stoageSetter("user", editInfo);
        login_user_data = stoageGetter("user");
        console.log("said", login_user_data);

        // stoageSetter("mobileNo", res.errMsg.mobile_no);
        // stoageSetter("state", res.errMsg.state);
        // stoageSetter("city", res.errMsg.city);
        ...
        // emailAddress = res.errMsg.primaryEmail;
        // setEmail(res.errMsg.primaryEmail);
        // setMobileNumber(res.errMsg.mobileNo);
        // setStateProvinceName(res.errMsg.state);
        // setCityProvinceName(res.errMsg.city);

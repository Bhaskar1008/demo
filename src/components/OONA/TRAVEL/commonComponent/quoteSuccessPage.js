...
export default function QuoteSuccessPage({
  ...
  const CTPLFlowListing = stateDatat?.ctplqoutation?.formData?.errMsg?.LOB
  ...
  const SelectedCommercialFromListing = useSelector((state) => state?.ctplqoutation?.formData?.errMsg?.quotation_group_info);
  ...
  const slectAgentCodeData = useSelector((state) => state?.ctplqoutation?.formData?.errMsg?.agentCode);

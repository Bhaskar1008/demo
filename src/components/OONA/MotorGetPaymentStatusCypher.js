      ...
      axios
        ...
        .then((response) => {
          if (response?.data?.errCode === -1) {
            console.log("response?.data----", response?.data?.errMsg?.data?.body?.responseCode);
            if (response?.data?.errMsg?.data?.body?.responseCode === "MA001") {
              ...
              if (
                response?.data?.errMsg?.data?.isCocafAuthenticated === false && response?.data?.errMsg?.data?.isCocafRequired === true
              ) {

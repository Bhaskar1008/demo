...
export default function QuoteSuccessPage({
  ...
  const slectedAgentCode = useSelector((state) => state?.motorQuotation?.formalQuotationSucess?.errMsg?.agentCode);
  console.log("slectedAgentCode", slectedAgentCode);

  // formalQuotationSucess?.formData?.errMsg?.agentCode
  // this is use to
  ...
  //     setlinkUrl(response.data?.errMsg);
  //     setopenloader(false);

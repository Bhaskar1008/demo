...
export default function PaymentSuccessMotor() {
  ...
  const PolicyNumber = useSelector(state => (state?.motorQuotation?.motorPolicyResponse?.errMsg?.oonaPolicyResponse?.policyNumber));
  console.log(PolicyNumber,"PolicyNumber")
  const ReferanceNumber = useSelector(state => (state?.motorQuotation?.motorPolicyResponse?.errMsg?.oonaPolicyResponse?.referenceNumber));
  const agentCodeFromPage = useSelector(state => (state?.motorQuotation?.motorQutotionSucess?.agentCode))

  const agentCodeFromPageNew = useSelector(state => (state?.motorQuotation?.motorPolicyResponse?.errMsg?.agentCode))

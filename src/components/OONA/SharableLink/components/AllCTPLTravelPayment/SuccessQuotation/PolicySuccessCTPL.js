...
export default function PolicySuccessCTPL() {
  ...
  const CTPLPolicyDataListingPage = useSelector((state) => state?.ctplPolicy?.formData?.errMsg);
  const CTPLPolicyData = useSelector((state) => state?.ctplPolicy?.formData?.errMsg);
  ...
  // let CTPLPolicyData = ALLdetails?.ctplPolicy?.formData?.errMsg

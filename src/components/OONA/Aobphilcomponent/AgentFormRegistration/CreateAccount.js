...
import LoginHeader from "../../../OONA/LoginHeader/LoginHeader";
...
// BPI FORM
    ...
    try {
      ...
      if (response?.data?.errCode === -1) {
        const allApplicationStatus = response?.data?.errMsg;
        setLoader(false);
  ...
  const handleUploadTinId = async ({ file, onError }) => {
    ...
    try {
      ...
      setLoader(false);
      if (response?.data?.errCode === -1) {
        setAffiliatTINID(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
        message.success(response?.data?.errMsg?.message);
      }
    } catch (error) {
      setLoader(false);
  ...
  const onChangeDeleteTIN = () =>{
   ...
   const handleUploadProofOfBank = async ({ file, onError }) => {
    ...
    try {
      ...
      setLoader(false);
      if (response?.data?.errCode === -1) {
        setPayloadAffiliatBankProof(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
        message.success(response?.data?.errMsg?.message);
      }
...
// delete Proof Of Bank for unlisence
 ...
 const handleUploadBPIaccountopening = async ({ file, onError }) => {
  ...
  try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadBPIAccountOpen(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }
...
const handleUploadTINIDLicense = async ({ file, onError }) => {
  ...
  if (file?.type === 'image/png' || file?.type === 'image/jpeg' || file?.type === 'image/jpg' || file?.type === 'application/pdf') {
    ...
    try {
      ...
      setLoader(false);
      if (response?.data?.errCode === -1) {
        setPayloadTINID(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
        message.success(response?.data?.errMsg?.message);
      }
...
const HandleallDocumnetUpload = async ({ file, onError },filetype) => {
  ...
  if (file?.type === 'image/png' || file?.type === 'image/jpeg' || file?.type === 'image/jpg' || file?.type === 'application/pdf') {
    ...
    try {
      ...
      setLoader(false);
      if (response?.data?.errCode === -1) {
        functiontonforsetdata(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
        // setPayloadTINID(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
        message.success(response?.data?.errMsg?.message);
      }
...
const handleUploadSSDIDLicense = async ({ file, onError }) => {
  ...
  try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadSSDID(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }
...
const handleUploadCAFORMLicense = async ({ file, onError }) => {
  ...
  try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadCAFORM(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }
...
const handleUploadPAYMENTLICENSEFEELicense = async ({ file, onError }) => {
  ...
  try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadPAYMENTLICENSEFEE(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }
...
const handleUploadClearanceFormLicense = async ({ file, onError }) => {
  ...
  try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadClearanceFormLicensed(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }
  ...
  img.onload = async function() {
      ...
      if (widthInches === heightInches) {
          try {
            ...
            setLoader(false);
            if (response?.data?.errCode === -1) {
              setPayloadPHOTOLicensed(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
              message.success(response?.data?.errMsg?.message);
            }
...
const handleUploadBIR2303License = async ({ file, onError }) => {
 ...
 try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadBIR2303Licensed(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }
...
const handleUploadBIR1921License = async ({ file, onError }) => {
 ...
 try {
    ...
    setLoader(false);
    if (response?.data?.errCode === -1) {
      setPayloadBIR1921Licensed(response?.data?.errMsg?.data?.documentUploadResult?.documentType)
      message.success(response?.data?.errMsg?.message);
    }

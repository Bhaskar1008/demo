...
const MotorComprehensive = React.lazy(() => import("./components/OONA/MotorComprehensive/MotorComprehensive"));
...
const Resource = React.lazy(() => import("./components/OONA/resources/ResourcesOona"));
const bulkHistoryDetails = React.lazy(() => import("./components/OONA/BulkHistoryDetails/BulkHistoryDetails"));
...
const BottomNavigation = React.lazy(() => import("./components/OONA/bottomNavigation/bottomNavigation"));
const OonaFooter = React.lazy(() => import("./components/OONA/OonaFooter/OonaFooter"));
...
const OonaDashboard = React.lazy(() => import("./components/OONA/DashBoard/OonaDashboard"));

const VehicalType = React.lazy(() => import("./components/OONA/CTPL/VehicalType"));

const PolicyType = React.lazy(() => import("./components/OONA/CTPL/PolicyType"));
const VehicalInformation = React.lazy(() => import("./components/OONA/CTPL/VehicalInformation/VehicalInformation"));

const CustomerInformation = React.lazy(() => import("./components/OONA/CTPL/CustomerInformation/CustomerInformation"));

const TravelInfo = React.lazy(() => import("./components/OONA/TRAVEL/TravelInfo/TravelInfo"));
const OonaLogin = React.lazy(() => import("./components/OONA/OonaLogin/OonaLogin"));
const TravelPage = React.lazy(() => import("./components/OONA/TRAVEL/TravelPage/TravelPage/TravelPage"));

const CustomerInformations = React.lazy(() => import("./components/OONA/TRAVEL/CustomerInformation/CustomerInformation"));

// const Success = React.lazy(() => import("./components/OONA/Success/Success"));
const TechnicalControl = React.lazy(() => import("./components/OONA/Success/TechnicalControl"));
const Fail = React.lazy(() => import("./components/OONA/Error/Error"));

const NotificationOona = React.lazy(() => import("./components/OONA/NotificationOona/NotificationOona"));

const PolicyHolder1 = React.lazy(() => import("./components/OONA/CTPL/PolicyHolder/PolicyHolder1"));
const VehicalInformationPage1 = React.lazy(() => import("./components/OONA/CTPL/VehicalInformation/VehicalInformationPage1"));
const PolicyGroup = React.lazy(() => import("./components/OONA/CTPL/PolicyGroup/PolicyGroup"));
const BulkUpload = React.lazy(() => import("./components/OONA/CTPL/BulkUpload/BulkUpload"));

const AllProduct = React.lazy(() => import("./components/OONA/AllProduct/AllProduct"));

const ConfirmPage = React.lazy(() => import("./components/OONA/CTPL/ConfirmPage/ConfirmPage"));

const HelpCenter = React.lazy(() => import("./components/OONA/Help Center/HelpCenter"));
const BulkUploadMotor = React.lazy(() => import("./components/OONA/MotorComprehensive/components/BulkUploadMotor"));

const PriceCheck1 = React.lazy(() => import("./components/OONA/MotorComprehensive/PriceCheck/PriceCheck"));

const PolicyGroupDetails = React.lazy(() => import("./components/OONA/MotorComprehensive/PolicyGroupDetails/PolicyGroupDetails"));

const VehicleInformationInfo = React.lazy(() => import("./components/OONA/MotorComprehensive/VehicleInformationDetails/VehicleInformationDetails"));

const vehicleQuote = React.lazy(() => import("./components/OONA/MotorComprehensive/VehicleQuote/VehicleQuote"));

const accessoryQuote = React.lazy(() => import("./components/OONA/MotorComprehensive/AccessoryQuote/AccessoryQuote"));

const coverageQuote = React.lazy(() => import("./components/OONA/MotorComprehensive/CoverageQuote/CoverageQuote"));

const policyHolderQuote = React.lazy(() => import("./components/OONA/MotorComprehensive/PolicyHolderInformationQuote/PolicyHolderInformationQuote"));

const riskInspection = React.lazy(() => import("./components/OONA/MotorComprehensive/RiskInspection/RiskInspection"));
const riskInspectionSuccess = React.lazy(() => import("./components/OONA/MotorComprehensive/RiskInspection/Success/Success"));

const MotorConfirmPage = React.lazy(() => import("./components/OONA/MotorComprehensive/MotorConfirmPage/MotorConfirmPage"));

const inspectionFileUpload = React.lazy(() => import("./components/OONA/MotorComprehensive/RiskInspection/InspectionFileUpload/InspectionFileUpload"));

const DocumentAlreadyUploaded = React.lazy(() => import("./components/OONA/MotorComprehensive/RiskInspection/Success/DocumentAlreadyUploaded"));
const quoteInformation = React.lazy(() => import("./components/OONA/MotorComprehensive/QuoteInformation/QuoteInformation"));

const QuotationSuccess = React.lazy(() => import("./components/OONA/MotorComprehensive/QuotationSuccessPage/QuotationSuccessPage"));

const CustomerDetail = React.lazy(() => import("./components/OONA/TRAVEL/CustomerDetails/CustomerDetail"));

const Performance = React.lazy(() => import("./components/OONA/PerformancePage/Performance"));

const CtplBulkUploadSuccess = React.lazy(() => import("./components/OONA/BulkUploadSuccess/BulkUploadSuccess"));
const CtplBulkUploadError = React.lazy(() => import("./components/OONA/BulkUploadError/BulkUploadError"));

const TravelBulkUploadSuccess = React.lazy(() => import("./components/OONA/BulkUploadSuccess/TravelBulkUploadSuccess"));
const TravelBulkUploadError = React.lazy(() => import("./components/OONA/BulkUploadError/TravelBulkUploadError"));

const MotorBulkUploadSuccess = React.lazy(() => import("./components/OONA/BulkUploadSuccess/MotorBulkUploadSuccess"));
const MotorBulkUploadError = React.lazy(() => import("./components/OONA/BulkUploadError/MotorBulkUploadError"));

const FormalQuoteInfo = React.lazy(() => import("./components/OONA/TRAVEL/FormalQuoteInfo/FormalQuoteInfo"));
const QuickQuoteInfo = React.lazy(() => import("./components/OONA/TRAVEL/QuickQuoteInfo/QuickQuoteInfo"));
const SuccessQuickPolicy = React.lazy(() => import("./components/OONA/TRAVEL/QuickQuoteInfo/SuccessQuickPolicy/SuccessQuickPolicy"));
const QuotePolicyInformation = React.lazy(() => import("./components/OONA/TRAVEL/QuotePolicyInformation/QuotePolicyInformation"));

const OonaCustomerListing = React.lazy(() => import("./components/OONA/OonaCustomerListing/OonaCustomerListing"));
const QuoteCode = React.lazy(() => import("./components/OONA/TRAVEL/QuoteCode/QuoteCode"));

const CustomerList = React.lazy(() => import("./components/OONA/AllCustomerDetails/CustomerList"));

// POLICY AND CTPL SUCCESS PAGE START HERE START HERE
const SuccessQuotation = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/SuccessQuotation"));
const CTPLSuccessQuotation = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/CTPLSuccessQuotation"));
const PolicySuccessTravel = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/policySuccessTravel"));
const PolicySuccessCTPL = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PolicySuccessCTPL"));
const PaymentSuccessCTPLDone = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentSuccessCTPL"));

const PaymentSuccessTravelDone = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentSuccessTravel"));
const PaymentCustomerPayTravelDone = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentCustomerPayTravel"));

// CYPHER PAYMENT ROUTING DATA START HERE
const PaymentSuccessTravelDoneCypher = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentSuccessTravelCypher"));

const PaymentFailedTravelCypher = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentFailedTravelCypher"));

const PaymentSuccessCTPLDoneCypher = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentSuccessCtplCypher"));

const PaymentFailedCTPLCypher = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentFailedCtplCypher"));

const PaymentFailedMotorCypher = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentFailedMotorCypher"));

const PaymentSuccessMotorDoneCypher = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentSuccessMotorCypher"));

// CYPHER PAYMENT ROUTING DATA END HERE

const PaymentFailedCTPL = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentFailedCTPL"));

const PaymentFailed = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/PaymentFailedTravel"));

const TechnicalControlForCTPL = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/TechnicalControlForCTPL"));

// PAYMENT LINK TO SEND CUSTOMER PAGE START HERE =====>

const PaymentLinkCustomerSend = React.lazy(() => import("./components/OONA/Success/Success"));
const PaymentLinkCustomerSendMotor = React.lazy(() => import("./components/OONA/Success/SuccessMotor"));
const PaymentLinkCustomerSendCTPL = React.lazy(() => import("./components/OONA/Success/SuccessCTPL"));
...
const TechnicalControlForMotor = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/TechnicalControlForMotor"));
const CustomerTechnicalControlForMotor = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/TechnicalControlForMotor"));

const FormalTechnicalControlForMotor = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/FormalTechnicalControlForMotor"));

const MotorSuccessQuotation = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/MotorSuccessQuotation"));

const motorQuotationPending = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/QuotationPendingMotor"));
const RiskInspectionRequiredMotor = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/RiskInspectionRequiredMotor"));

const motorPolicyPaymentPage = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/PolicySuccessMotor"));

const motorPolicyCustomerPayPage = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/PaymentCustomerPayMotor"));

const motorPolicyTechnicalControl = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/PolicyTechnicalControlMotor"));

const motorPolicySuccessPage = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/PaymentSuccessMotor"));

const CustomermotorPolicySuccessPage = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/PaymentSuccessMotor"));
const CustomermotorPolicyFailedPage = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/PaymentFailedMotor"));
const CustomermotorPolicyCustomerPayPage = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/PaymentCustomerPayMotor"));
const motorPolicyFailedPage = React.lazy(() => import("./components/OONA/MotorComprehensive/SuccessQuotation/PaymentFailedMotor"));

// POLICY AND END SUCCESS PAGE END HERE START HEREtechnical control

const QuotationPending = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/QuotationPending"));
const TravelTechnicalControl = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/travelTechnicalControl"));
// this for the coca
const motorCoca = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/CocPaymentFailedMotor"));
const CtplCoca = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/CocPaymentFailedCtpl"));
const TravelCoca = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/CocPaymentFailedTravel"));
const TravelQuotePending = React.lazy(() => import("./components/OONA/TRAVEL/SuccessQuotation/TravelQuotePending"));

// POLICY AND CTPL SUCCESS PAGE START HERE

const TravelerDetials = React.lazy(() => import("./components/OONA/TRAVEL/TravelerDetials/TravelerDetials"));

const ResourceCenter = React.lazy(() => import("./components/SalesPitch/ResourceCenter"));

const TravelBulkUpload = React.lazy(() => import("./components/OONA/TRAVEL/TravelBulkUpload/TravelBulkUpload"));
const TravelPolicyGroup = React.lazy(() => import("./components/OONA/TRAVEL/TravelPolicyGroup/TravelPolicyGroup"));
const PolicyHolder = React.lazy(() => import("./components/OONA/MotorComprehensive/PolicyHolder/PolicyHolder"));
const AlternatePolicyHolder = React.lazy(() => import("./components/OONA/MotorComprehensive/AlternatePolicyHolder/AlternatePolicyHolder"));

// pament status CTPL , MOTOR , TRAVEL
const GetPaymentStatus = React.lazy(() => import("./components/OONA/GetPaymentStatus"));
const MotorGetPaymentStatus = React.lazy(() => import("./components/OONA/MotorGetPaymentStatus"));
const CustomerMotorGetPaymentStatus = React.lazy(() => import("./components/OONA/SharableLink/MotorGetPaymentStatus"));
const TravelGetPaymentStatus = React.lazy(() => import("./components/OONA/TravelGetPaymentStatus"));

const TravelGetPaymentStatusCypher = React.lazy(() => import("./components/OONA/TravelGetPaymentStatusCypher"));
const CTPLGetPaymentStatusCypher = React.lazy(() => import("./components/OONA/CTPLGetPaymentStatusCypher"));

const MotorGetPaymentStatusCypher = React.lazy(() => import("./components/OONA/MotorGetPaymentStatusCypher"));

const MotorBulkUpload = React.lazy(() => import("./components/OONA/MotorComprehensive/MotorBulkUpload/MotorBulkUpload"));

// Cypher payment page ---

const CTPLCypherPayment = React.lazy(() => import("./components/OONA/PaymentCypher/CtplCypher/CtplCypherPaymentSuccess"));

const TravelCypherPayment = React.lazy(() => import("./components/OONA/PaymentCypher/TravelCypher/TravelCypherPaymentSuccess"));

const MotorCypherPayment = React.lazy(() => import("./components/OONA/PaymentCypher/MotorCypher/MotorCypherPaymentSuccess"));
const SharableLogin = React.lazy(() => import("./components/OONA/SharableLink/components/SharableLogin/SharableLogin"));
const customerListingPage = React.lazy(() => import("./components/OONA/SharableLink/components/Listing/QuotationsPoliciesMaster/quotationPolycies"));
const MobileLogin = React.lazy(() => import("./components/OONA/SharableLink/components/SharableLogin/Mobilelogin"));
const PolicyPage = React.lazy(() => import("./components/OONA/SharableLink/components/PolicyPage/PolicyPage"));
//
...
const CustomerMotorSuccessQuotation = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/MotorSuccessQuotation"));

// ================ For Customer sharblelink start here =========================

const quoationPolicyTab = React.lazy(() => import("./components/OONA/SharableLink/components/QuotationPolicyTab/QuotationPolicyTab"));

//
// motoshare for the customer will start from here
const motorCustomerPolicyHolder = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/PolicyHolder/PolicyHolder"));
const HypervergeTest = React.lazy(() => import("./components/OONA/SharableLink/sharable_hyepr/PolicyHyper"));
const motorCustomerAlternatePolicyHolder = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/AlternatePolicyHolder/AlternatePolicyHolder"));
const motorCustomerConfirmPage = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/MotorConfirmPage/MotorConfirmPage"));
const motorCustomerFormalTechnicalControl = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/FormalTechnicalControlForMotor"));

const motorCustomerPolicyTechnicalControl = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/PolicyTechnicalControlMotor"));
const CustomermotorPolicyPaymentPage = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/PolicySuccessMotor"));
const customermotorPolicyCustomerPayPage = React.lazy(() => import("./components/OONA/SharableLink/components/motor_sharable_comp/SuccessQuotation/PaymentCustomerPayMotor"));
// motoshare for the customer will end here

const CustomerPolicyHolder1 = React.lazy(() => import("./components/OONA/SharableLink/components/CustomerSharableLinkCTPL/PolicyHolder/PolicyHolder1"));
const CustomerVehicalInformationPage1 = React.lazy(() => import("./components/OONA/SharableLink/components/CustomerSharableLinkCTPL/VehicalInformation/VehicalInformationPage1"));
const CustomerVehicalInformation = React.lazy(() => import("./components/OONA/SharableLink/components/CustomerSharableLinkCTPL/VehicalInformation/VehicalInformation"));
const CustomerPolicyGroup = React.lazy(() => import("./components/OONA/SharableLink/components/CustomerSharableLinkCTPL/PolicyGroup/PolicyGroup"));
const SharableLinkCustomerInformation = React.lazy(() => import("./components/OONA/SharableLink/components/CustomerSharableLinkCTPL/CustomerInformation/CustomerInformation"));
const CustomerConfirmPage = React.lazy(() => import("./components/OONA/SharableLink/components/CustomerSharableLinkCTPL/ConfirmPage/ConfirmPage"));

const CustomerCTPLSuccessQuotation = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/CTPLSuccessQuotation"));

const CustomerQuotationPending = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/QuotationPending"));
const CustomerPolicySuccessCTPL = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/PolicySuccessCTPL"));
const CustomerTechnicalControlForCTPL = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/TechnicalControlForCTPL"));
const CustomerPaymentFailedCTPL = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/PaymentFailedCTPL"));

const CustomerPaymentSuccessCTPL = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/PaymentSuccessCTPL"));

const CustomerGetPaymentStatus = React.lazy(() => import("./components/OONA/SharableLink/components/GetPaymentStatus"));
const CustomerCtplCoca = React.lazy(() => import("./components/OONA/SharableLink/components/AllCTPLTravelPayment/SuccessQuotation/CocPaymentFailedCtpl"));
// ================ For Customer sharblelink end here =========================

// ================ For Agent Login Registration start here =========================
// const AgentLogin = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentLoginResig/AgentLogin"));
// ================ For Agent Login Registration end here =========================

// ================ Agent Form Registration start here ============================

// const AgentForm = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/AgentForm"));
// const CreateAccount = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/CreateAccount"));
// const ApplicationStatus = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/ApplicationStatus"));
// const VerifyDetails = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/VerifyDetails"));

const AgentLogin = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentLoginResig/NewAgentLogin"));
...
const AgentLoginNew = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentLoginResig/AgentLogin.js"));
const NewRegister = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentLoginResig/NewRegister.js"));
// ================ For Agent Login Registration end here =========================
...
const ApplicationStatus = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/ApplicationStatus"));
const VerifyDetails = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/VerifyDetails"));
const successProfile = React.lazy(() => import("./components/OONA/Aobphilcomponent/AgentFormRegistration/successProfile.js"));

// +++++++++++++++++++ Shareable link for travel routes =============================

const SharableLinkQuoteCode = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/QuoteCode/QuoteCode"));
...
const ShareableLinkTravelInfo = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/TravelInfo/TravelInfo"));
const ShareableTravelPolicyGroup = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/TravelPolicyGroup/TravelPolicyGroup"));

const ShareableTravelQuotePending = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/SuccessQuotation/TravelQuotePending"));

const ShareableCustomerDetail = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/CustomerDetails/CustomerDetail"));
const ShareableTravelPage = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/TravelPage/TravelPage/TravelPage"));
const SharableSuccessQuotation = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/SuccessQuotation/SuccessQuotation"));
const ShareableCustomerInformation = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/CustomerInformation/CustomerInformation"));
const ShareableTravelerDetials = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/TravelerDetials/TravelerDetials"));
const ShareableFormalQuoteInfo = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/FormalQuoteInfo/FormalQuoteInfo"));
const ShareablePolicySuccessTravel = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/SuccessQuotation/policySuccessTravel"));
const ShareableTravelTechnicalControl = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/SuccessQuotation/travelTechnicalControl"));

const ShareableTravelGetPaymentStatus = React.lazy(() => import("./components/OONA/SharableLink/components/TravelGetPaymentStatus"));

const ShareableTravelGetPaymentStatusCypher = React.lazy(() => import("./components/OONA/SharableLink/components/TravelGetPaymentStatusCypher"));

const ShareableTravelCypherPayment = React.lazy(() => import("./components/OONA/SharableLink/components/PaymentCypher/TravelCypher/TravelCypherPaymentSuccess"));
const ShareablePaymentFailed = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/SuccessQuotation/PaymentFailedTravel"));
const ShareablePaymentSuccessTravelDone = React.lazy(() => import("./components/OONA/SharableLink/components/ShareableLinkTravel/SuccessQuotation/PaymentSuccessTravel"));

// ============= bulk issuance history ==============
const BulkIssuanceHistory = React.lazy(() => import("./components/OONA/BulkUploadHistory/BulkUploadHistory"));
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
const AuthorizationTokenError = React.lazy(() => import("./components/OONA/SharableLink/AuthorizationFailedPage/AuthorizationFailedPage"));

const performanceDashboard = React.lazy(() => import("./components/OONA/DashBoard/performanceDashboard.js"));
function App() {

          ...
          <Col xs={24} sm={20} md={16} lg={12} xl={8}>
            ...
            >
              ...
              <div style={{ margin: "16px 0" }}>
                <Text strong color="#00BFFF">
                  Register as{" "}
                </Text>
                <Select value={role} onChange={(value) => setRole(value)} bordered={false} style={{ color: "#FF6A00", fontWeight: "bold" }}>
              ...
              <div className="consent-checkbox" style={{ display: "flex", justifyContent: "flex-start" }}>
                <Checkbox
                  ...
                  style={{
                    ...
                    "--antd-wave-shadow-color": "#FF6A00", // For wave effect
                    "--checkbox-color": "#FF6A00",
                  }}
                >
                  <span style={{ borderBottom: "1px solid #444444", fontWeight: "500", fontSize: "14px" }}>Data Privacy Consent</span>
                </Checkbox>
              </div>
              <Row gutter={12} style={{ marginTop: 24 }}>
                <Col span={12}>
                  <Button block style={{ borderColor: "#00BFFF", color: "#00BFFF", width: "100%", borderRadius: "8px" }}>
                    Cancel
                  </Button>
                </Col>
                <Col span={12}>
                  <Button type="primary" block style={{ backgroundColor: consent ? "#FF6A00" : "#7C7C7C", borderColor: "#7C7C7C", width: "100%", borderRadius: "8px", color: "#ffffff" }} onClick={() => handleRegister()} disabled={!consent}>
                    Register
                  </Button>
                </Col>
              </Row>
